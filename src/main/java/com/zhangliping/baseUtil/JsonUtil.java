...
/**
 * 项目名：tob
 * 包名：com.tuniu.ngsp.nws.support.util
 * 文件名：JsonUtil.java *
 * 日期：2016-9-30 上午11:20:45
 * 版权所有
 */
...
public class JsonUtil {
    ...
    public static String toString(Object obj) {
        ...
        try {
            return JacksonWrapper.toJsonString(obj);
        } catch (Exception e) {
            LOG.error("JacksonWrapper.toJsonString error: ", e);
        }
        return null;
    }
    ...
    public static String toString(Object obj, DateFormat dateFormat) {
        ...
        try {
            return JacksonWrapper.toJsonString(obj, dateFormat);
        } catch (Exception e) {
    ...
    public static <T> T toBean(Object obj, Class<T> cls) {
        ...
        try {
            return JacksonWrapper.toObject(JsonUtil.toString(obj), cls);
        } catch (Exception e) {
            LOG.error("JacksonWrapper.toObject error: ", e);
        }
        return null;
    }
